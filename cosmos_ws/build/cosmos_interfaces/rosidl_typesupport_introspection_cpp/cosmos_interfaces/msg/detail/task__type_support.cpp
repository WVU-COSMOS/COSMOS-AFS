...
{
  new (message_memory) cosmos_interfaces::msg::Task(_init);
}

void Task_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cosmos_interfaces::msg::Task *>(message_memory);
  typed_message->~Task();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Task_message_member_array[3] = {
  {
    ...
    offsetof(cosmos_interfaces::msg::Task, mission),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cosmos_interfaces::msg::Task, node),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cosmos_interfaces::msg::Task, is_done),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Task_message_members = {
  ...
  "Task",  // message name
  3,  // number of fields
  sizeof(cosmos_interfaces::msg::Task),
...
{
  return &::cosmos_interfaces::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cosmos_interfaces, msg, Task)() {
  return &::cosmos_interfaces::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
