...
{
  new (message_memory) cosmos_interfaces::msg::StateMachine(_init);
}

void StateMachine_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cosmos_interfaces::msg::StateMachine *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StateMachine_message_member_array[4] = {
  {
    ...
    offsetof(cosmos_interfaces::msg::StateMachine, mission),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cosmos_interfaces::msg::StateMachine, to_node),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cosmos_interfaces::msg::StateMachine, is_abort),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::cosmos_interfaces::msg::rosidl_typesupport_introspection_cpp::StateMachine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cosmos_interfaces, msg, StateMachine)() {
  return &::cosmos_interfaces::msg::rosidl_typesupport_introspection_cpp::StateMachine_message_type_support_handle;
}
