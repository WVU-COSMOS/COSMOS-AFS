...
# ======================================================================================================================
# ======================================================================================================================
# ============================================== BEGIN SCRIPT FOR COSMOS ===============================================
# ======================================================================================================================

# above from:
#   - https://yasoob.me/posts/understanding-and-writing-jpeg-decoder-in-python/
#       - https://github.com/yasoob/Baseline-JPEG-Decoder/tree/master
...
while True:
    ...
    ser.write(b'C')
    try:
        img_length = ser.read(2) # esp32 coded to send length of jpeg bytes as first n bytes
        ...
        # with open('test_for_COSMOS.jpg', "wb") as f:
        #     f.write(img_data)
        ...
        master = Tk()
        w = Canvas(master, width=1600, height=1200) # Error: list index out of range
        w.pack()
